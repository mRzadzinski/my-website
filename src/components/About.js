	...
	return (
		<div className='About'>
			...
			<div className='about-content'>
				I may have covered a distance <nobr>of 240 km (149 mi)</nobr> on a bike{' '}
				...
				computer related interests, and my cheeks are always turning red when
				reading about <nobr>the newest</nobr> tech related achievements.
				<br />
				<br />
				...
				<ul>
					...
					<li>I improved my English from shaky B2 to usable C1.</li>
					<li>I learn to play guitar five days a week - it’s scheduled.</li>
				</ul>
